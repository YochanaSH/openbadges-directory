var Cloudant       = require('../engine'),
    ...
    queryInterval = config('QUERY_INTERVAL', '2 MINUTE');
...
var getAndIndexEndpoints = function (err, rows) {
  ...
  async.each(rows, function (row, callback) {
    ...
    engine.deleteByEndpoint(row.endpoint, function (err) {
